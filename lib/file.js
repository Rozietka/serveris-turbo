 ...
 * @param {string} dir Folderio pavadinimas, kuriame bus skaitomi failai (`.data` folderyje).
 * @returns {Promise<[boolean, string[]|object]>} Statusas, ar pavyko perskaityti failu pavadinimus; Proceso rezultatas.
 */
file.list = async (dir) => {
